    ...
    <div class="content_slider">
      <div class="content_slider_left">
        ...
        <div class="content_slider_left_body">
          <span class="left_imdb">imdb 7.4</span>
        ...
        <div class="content_slider_left_description">
          <h1 class="content_slider_left_name">The Devil All the Time</h1>
          <h2 class="content_slider_left_name2">The Devil All the Time</h2>
        </div>
      </div>
      <div class="content_slider_right">
        ...
        <div class="content_slider_right_description">
          <h1 class="content_slider_right_name">The Devil All the Time</h1>
          <h2 class="content_slider_right_name2">The Devil All the Time</h2>
        </div>
      </div>
    </div>
  </div>`;
